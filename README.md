...
My project is a magnetic field visualizer basically i will use an arduino and a hall effect sensor to measure the strength and also find the polarity of a magnetic field it, will also have a potentiometer to adjust sensitivity, and a LED matrix to visualize all that
